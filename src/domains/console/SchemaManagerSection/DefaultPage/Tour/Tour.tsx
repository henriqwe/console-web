...
export function Tour() {
  ...
  useEffect(() => {
    setIsOpen(false)
    setShowGreeting(!getToured().database)
    setSteps(tourSteps)
    setCurrentStep(0)
  }, [])
          ...
          <div className="flex gap-x-12">
            <div className="flex flex-col">
              <h3 className="text-lg font-medium leading-6 text-gray-900">
                Welcome to your project's database
              </h3>
              <div className="mt-2 max-w-xl text-sm text-gray-500">
                <p>
                  This is where you can create, modify and remove entities from
                  your schema.
                </p>
                <p>Let's get you started with a quick look around.</p>
              </div>
