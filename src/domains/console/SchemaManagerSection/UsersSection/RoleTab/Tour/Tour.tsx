...
export function Tour() {
  ...
  useEffect(() => {
    setShowGreeting(!getToured().roles)
    setSteps(tourSteps)
    setCurrentStep(0)
  }, [])
          ...
          <div className="flex gap-x-12">
            <div className="flex flex-col">
              <h3 className="text-lg font-medium leading-6 text-gray-900">
                Welcome to the Roles section!
              </h3>
              <div className="mt-2 max-w-xl gap-y-4 flex flex-col text-sm text-gray-500">
                <p>
                  Here you can create roles to control who has access to your
                  schema data, and, later on, associate them with specific users
                  you create.
                </p>
