    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75 dark:bg-gray-700 dark:bg-opacity-75" />
        </Transition.Child>
          ...
          <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:max-w-lg sm:w-full">
                ...
                <div className="px-4 py-3 bg-gray-50 dark:bg-[#253141] sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                  ...
                  <button
                    type="button"
                    className="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-indigo-700 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
