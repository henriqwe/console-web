...
const PROTOCOL = 'http';
const baas_address = 'api.ycodify.com:8080';
const api = {
    credentials: {
        password: "",
        username: "tester"
    ...
    endpoint: {
        auth: {
            ...
            headers: {
                ...
                'Authorization': 'Basic '.concat(btoa('yc:c547d72d-607c-429c-81e2-0baec7dd068b'))
            },
        ...
        account: {
            ...
            update: {
                url: PROTOCOL + '://' + baas_address + '/api/account/account/username/{username}/version/{version}',
                headers: {
                    'X-TenantID': '',
                    'Content-Type': 'application/json',
            ...
            updatePassword: {
                url: PROTOCOL + '://' + baas_address + '/api/account/account/username/{username}/version/{version}/update-password',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
                    'Authorization': 'Bearer {TOKEN}'
        ...
        igrid: {
            log: {
                error: {
                    get: {
                        url: PROTOCOL + '://' + baas_address + '/api/s-monitor/log/error/operation/{operation}/time/{time}/{op}',
                        headers: {
                            'Authorization': 'Bearer {TOKEN}',
                            'X-TenantID': '',
                            'Accept': 'application/json'
        ...
        backend: {
            ...
            account: {
                ...
                updatePassword: {
                    url: PROTOCOL + '://' + baas_address + '/api/caccount/account/password',
                    headers: {
                        'X-TenantID': '',
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
                ...
                delete: {
                    url: PROTOCOL + '://' + baas_address + '/api/caccount/account/username/{username}/version/{version}',
                    headers: {
                        'X-TenantID': '',
                        'Authorization': 'Bearer {TOKEN}'
                    },
            ...
            role: {
                ...
                update: {
                    url: PROTOCOL + '://' + baas_address + '/api/caccount/role/name/{name}',
                    headers: {
                        'X-TenantID': '',
                        'Content-Type': 'application/json',
                        'Authorization': 'Bearer {TOKEN}'
        ...
        modeling: {
            parser: {
                ...
                generate_cli: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/parser/generate-cli',
                    headers: {
                        'Content-Type': 'text/plain',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                generate_scripts: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/parser/generate-scripts/{script-type}',
                    headers: {
                        'Content-Type': 'text/plain',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                reverse: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/parser/reverse/{path-to-object}',
                    headers: {
                        'Authorization': 'Bearer {TOKEN}',
                        'Accept': 'text/plain'
                    },
            ...
            schema: {
                tagged: {
                    create: {
                        url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/tag-with/{tag}',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': 'Bearer {TOKEN}'
                        },
                    ...
                    get: {
                        url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/tagged-by/{tag}',
                        headers: {
                            'Accept': 'application/json',
                            'Authorization': 'Bearer {TOKEN}'
                        },
                    ...
                    get_all: {
                        url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/taggeds',
                        headers: {
                            'Accept': 'application/json',
                            'Authorization': 'Bearer {TOKEN}'
                        },
                ...
                read_all: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql',
                    headers: {
                        'Accept': 'application/json',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                update: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                caa: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/create-admin-account',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                yumlCD: {
                    url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/for-graphical-view/show-attributes/{hasAttr}',
                    headers: {
                        'Accept': 'text/plain',
                        'Authorization': 'Bearer {TOKEN}'
                    },
                ...
                entity: {
                    create: {
                        url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': 'Bearer {TOKEN}'
                        },
                    ...
                    read: {
                        url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': 'Bearer {TOKEN}'
                        },
                    ...
                    attribute: {
                        create: {
                            url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}/attribute',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': 'Bearer {TOKEN}'
                            },
                        ...
                        update: {
                            url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}/attribute/{attributeName}',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': 'Bearer {TOKEN}'
                            },
                    ...
                    relationship: {
                        create: {
                            url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}/association',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': 'Bearer {TOKEN}'
                            },
                        ...
                        update: {
                            url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}/association/{relationshipName}',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': 'Bearer {TOKEN}'
                            },
                        ...
                        delete: {
                            url: PROTOCOL + '://' + baas_address + '/api/modeler/schema/{schemaName}/sql/entity/{entityName}/association/{relationshipName}/type/{relationshipType}',
                            headers: {
                                'Content-Type': 'application/json',
                                'Authorization': 'Bearer {TOKEN}'
                            },
...
const _gtools_lib = {
    type: {
        Java: ['String', 'Long', 'Timestamp', 'Boolean', 'Integer', 'Double', 'Date']
    },
    ...
    request: function(endpoint, data, callback, type) {
        ...
        if (type == 'login') {
            ...
            return;
             */
            xhttp.open(endpoint.httpMessageType,
                endpoint.url, true);
            ...
            if (endpoint.headers['Authorization']) {
                xhttp.setRequestHeader('Authorization',
                    endpoint.headers['Authorization'].replace('{TOKEN}',
    ...
    baas: {
        request: function(tenantID, jwtoken, data, callback, type, endpoint) {
            let xhttp = new XMLHttpRequest();
            if (type == 'login') {
                xhttp.open('POST', PROTOCOL + '://' + baas_address
                    + '/api/csecurity/oauth/token', true);
                xhttp.setRequestHeader('Content-Type',
                ...
                xhttp.setRequestHeader('X-TenantID', tenantID);
                xhttp.setRequestHeader('Authorization',
                    'Bearer '.concat(jwtoken));
                if (endpoint.httpMessageType == 'POST'
                    || endpoint.httpMessageType == 'PUT') {
                    xhttp.setRequestHeader('Content-Type', 'application/json');
                    xhttp.send(JSON.stringify(data));
                } else if (endpoint.httpMessageType == 'GET'
        ...
        ds_data_backup_request: function(tenantID, jwtoken, data, callback) {
            let xhttp = new XMLHttpRequest();
            xhttp.open(api.endpoint.backend.ds.data_backup.httpMessageType, api.endpoint.backend.ds.data_backup.url, true);
        ...
        ds_data_restore_request: function(tenantID, jwtoken, data, callback) {
            let xhttp = new XMLHttpRequest();
            xhttp.open(api.endpoint.backend.ds.data_restore.httpMessageType,
                api.endpoint.backend.ds.data_restore.url, true);
            xhttp.setRequestHeader('X-TenantID', tenantID);
            xhttp.setRequestHeader('Authorization', 'Bearer '.concat(jwtoken));
            xhttp.onreadystatechange = function() {
                if (xhttp.readyState == 4) {
